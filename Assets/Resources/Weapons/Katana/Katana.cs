...
public class Katana : WeaponDesign
{
    ...
    //     vfxProcessor.ActivateSequencedResource("Frame", frameId + 1, (GameObject o) => { DissolveItem(o, 1); });
    //
    //     switch (frameId)
    //     {
    //         case 0:
    //             _hands.rightHand.ChangeColorSmooth(new Color(0.1f, 0, 0.2f, 0.55f),
    //                 new ColorParams(HandShaderProps.MainColor, 3, false));
    //             _hands.leftHand.ChangeColorSmooth(new Color(0.1f, 0, 0.2f, 0.55f),
    //                 new ColorParams(HandShaderProps.MainColor, 3, false));
    //             _hands.rightHand.ChangeColorSmooth(new Color(0.53f, 0, 0.8f, 0),
    //                 new ColorParams(HandShaderProps.EdgeColor, 3, false));
    //             _hands.leftHand.ChangeColorSmooth(new Color(0.53f, 0, 0.8f, 0),
    //                 new ColorParams(HandShaderProps.EdgeColor, 3, false));
    //             break;
    //         case 1:
    //             _hands.rightHand.ChangeColorSmooth(new Color(0.53f, 0, 0.8f),
    //                 new ColorParams(HandShaderProps.EdgeColor, 3, false));
    //             _hands.leftHand.ChangeColorSmooth(new Color(0.53f, 0, 0.8f),
    //                 new ColorParams(HandShaderProps.EdgeColor, 3, false));
    //             break;
    //         case 2:
