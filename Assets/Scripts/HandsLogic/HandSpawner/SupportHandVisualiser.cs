...
namespace Scripts.HandsLogic
{
    ...
    public class SupportHandVisualiser: MonoBehaviour
    {
        ...
        [SerializeByType("Scripts.HandsLogic.VisualizationType",0)]
        public GameObject LeftHand;
        [SerializeByType("Scripts.HandsLogic.VisualizationType","Mesh")]
        public GameObject RightHand;
        [SerializeByType("Scripts.HandsLogic.VisualizationType","Bones")]
