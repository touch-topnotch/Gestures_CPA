    ...
    public class CustomHandVisualizer : RigComponent
    {
        ...
        class HandGameObjects
        {
                ...
                float positionSpeed)
            {
                ...
                m_DrawJointsParent.transform.parent = m_HandMesh.transform;
                ...
                bool cacheParentPose = true)
            {
                ...
                xform.localPosition = Vector3.Lerp(xform.localPosition,
                    inverseParentRotation * (pose.position - parentPose.position), Time.deltaTime * m_positionSpeed);
