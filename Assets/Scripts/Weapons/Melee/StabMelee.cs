...
public class StabMelee : Melee
{
    ...
    private Vector3 WeaponStabDirection => _bladePoint.position - _weaponPoint.position;

    private float GetBladeSpeedAlongStabDirection(Vector3 bladeSpeedVec)
    {
        return Vector3.Dot(WeaponStabDirection, bladeSpeedVec) / bladeSpeedVec.magnitude;
    }
