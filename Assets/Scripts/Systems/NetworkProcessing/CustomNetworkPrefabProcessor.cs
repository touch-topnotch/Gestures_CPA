...
{
    public class CustomNetworkPrefabProcessor : AssetPostprocessor
    {
        private static string s_DefaultNetworkPrefabsPath = "Assets/Configs/NetworkPrefabs.asset";
        ...
        private static CustomNetworkPrefabsList s_PrefabsList;
        ...
        // }
        //
        // internal static CustomNetworkPrefabsList GetOrCreateNetworkPrefabs(string path, out bool isNew, bool addAll)
        // {
        //     var defaultPrefabs = AssetDatabase.LoadAssetAtPath<CustomNetworkPrefabsList>(path);
        //     if (defaultPrefabs == null)
        //     {
        //         isNew = true;
        //         defaultPrefabs = ScriptableObject.CreateInstance<CustomNetworkPrefabsList>();
