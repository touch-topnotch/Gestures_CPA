...
namespace Scripts.Movements
{
    public static class HeadManipulations
    {
        ...
        private static float HeadYVelocity(in Vector3 direction, in float distance, in float startDistance = 0.2f,
            in float speed = 1f)
        {
            if (distance < startDistance)
            {
        ...
        private static float XZDistance(in Vector3 a, in Vector3 b) =>
