...
namespace Scripts.Rigs
{
    ...
    public class OVRRig : Rig
    {
        ...
        /// </summary>
        public event System.Action<OVRRig> UpdatedAnchors;
        ...
        /// </summary>
        [Header("OVR Properties")] public bool usePerEyeCameras = false;
        ...
        protected virtual void UpdateAnchors(bool updateEyeAnchors, bool updateHandAnchors)
        {
            ...
            if (updateEyeAnchors)
            {
                if (hmdPresent)
                {
                    ...
                    if (OVRNodeStateProperties.GetNodeStatePropertyVector3(Node.CenterEye,
                ...
                else
                {
                    ...
                    if (OVRNodeStateProperties.GetNodeStatePropertyVector3(Node.RightEye,
                            NodeStatePropertyType.Position,
